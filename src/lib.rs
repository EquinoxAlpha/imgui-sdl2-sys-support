...
use bindings::{
    ...
    SDL_KeyCode_SDLK_0, SDL_KeyCode_SDLK_1, SDL_KeyCode_SDLK_2, SDL_KeyCode_SDLK_3,
    SDL_KeyCode_SDLK_4, SDL_KeyCode_SDLK_5, SDL_KeyCode_SDLK_6, SDL_KeyCode_SDLK_7,
    SDL_KeyCode_SDLK_8, SDL_KeyCode_SDLK_9, SDL_KeyCode_SDLK_APPLICATION,
    SDL_KeyCode_SDLK_BACKQUOTE, SDL_KeyCode_SDLK_BACKSLASH, SDL_KeyCode_SDLK_BACKSPACE,
    SDL_KeyCode_SDLK_CAPSLOCK, SDL_KeyCode_SDLK_COMMA, SDL_KeyCode_SDLK_DELETE,
    ...
    SDL_KeyCode_SDLK_F2, SDL_KeyCode_SDLK_F3, SDL_KeyCode_SDLK_F4, SDL_KeyCode_SDLK_F5,
    SDL_KeyCode_SDLK_F6, SDL_KeyCode_SDLK_F7, SDL_KeyCode_SDLK_F8, SDL_KeyCode_SDLK_HOME,
    SDL_KeyCode_SDLK_INSERT, SDL_KeyCode_SDLK_KP_0, SDL_KeyCode_SDLK_KP_1, SDL_KeyCode_SDLK_KP_2,
    SDL_KeyCode_SDLK_KP_3, SDL_KeyCode_SDLK_KP_4, SDL_KeyCode_SDLK_KP_5, SDL_KeyCode_SDLK_KP_6,
    SDL_KeyCode_SDLK_KP_7, SDL_KeyCode_SDLK_KP_8, SDL_KeyCode_SDLK_KP_9,
    SDL_KeyCode_SDLK_KP_DIVIDE, SDL_KeyCode_SDLK_KP_ENTER, SDL_KeyCode_SDLK_KP_EQUALS,
    SDL_KeyCode_SDLK_KP_MINUS, SDL_KeyCode_SDLK_KP_MULTIPLY, SDL_KeyCode_SDLK_KP_PERIOD,
    SDL_KeyCode_SDLK_KP_PLUS, SDL_KeyCode_SDLK_LALT, SDL_KeyCode_SDLK_LCTRL, SDL_KeyCode_SDLK_LEFT,
    ...
    SDL_KeyCode_SDLK_w, SDL_KeyCode_SDLK_x, SDL_KeyCode_SDLK_y, SDL_KeyCode_SDLK_z,
    SDL_Keymod, SDL_Keymod_KMOD_ALT, SDL_Keymod_KMOD_CTRL, SDL_Keymod_KMOD_GUI,
    SDL_Keymod_KMOD_SHIFT, SDL_Scancode_SDL_SCANCODE_A, SDL_Scancode_SDL_SCANCODE_BACKSPACE,
    SDL_Scancode_SDL_SCANCODE_C, SDL_Scancode_SDL_SCANCODE_DELETE, SDL_Scancode_SDL_SCANCODE_DOWN,
    ...
    SDL_WindowFlags_SDL_WINDOW_INPUT_FOCUS, SDL_WindowFlags_SDL_WINDOW_MINIMIZED, SDL_BUTTON_LEFT,
    SDL_BUTTON_MIDDLE, SDL_BUTTON_RIGHT, SDL_BUTTON_X1, SDL_BUTTON_X2, SDL_EventType_SDL_MOUSEBUTTONUP, SDL_KeyCode_SDLK_F9,
};
...
use imgui_sys::{
    ...
    ImGuiKey_F, ImGuiKey_F1, ImGuiKey_F11, ImGuiKey_F12, ImGuiKey_F2, ImGuiKey_F3,
    ImGuiKey_F4, ImGuiKey_F5, ImGuiKey_F6, ImGuiKey_F7, ImGuiKey_F8, ImGuiKey_F9, ImGuiKey_G,
        ...
        unsafe {
            match event.type_ {
                SDL_EventType_SDL_MOUSEWHEEL => {
                    ...
                    imgui_sys::ImGuiIO_AddMouseWheelEvent(io.raw_mut(), -event.wheel.preciseX, event.wheel.preciseY);
                ...
                SDL_EventType_SDL_MOUSEBUTTONDOWN => {
                    ...
                    imgui_sys::ImGuiIO_AddMouseButtonEvent(io.raw_mut(), mouse_button, event.type_ == SDL_EventType_SDL_MOUSEBUTTONDOWN);
                ...
                SDL_EventType_SDL_MOUSEMOTION => {
                    imgui_sys::ImGuiIO_AddMousePosEvent(io.raw_mut(), event.motion.x as f32, event.motion.y as f32);
